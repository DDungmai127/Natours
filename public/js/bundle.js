        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                email: email,
                password: password //enhance object
              }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error loggingout! Try again');
          case 10:
          case "end":
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHVuZ21haXZuIiwiYSI6ImNsYml1MThkcjBwbHgzb28wMzhyamYxZnUifQ.XWEIe38C29L3W-_JNT751g';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51MMWJKALMLwYdibkJcgPhrVBL0KV3AOxTIRrd4EZbueRdVFSJVboOvrdntf4gSyBVrH1CNyxLq0xZUGMF9k2nalQ00qnePE1zM'); // 1) Get Checkout session from API
            _context.prev = 1;
            _context.next = 4;
...
var userPasswordForm = $('.form-user-password');
var bookBtn = $('#book-tour');
var reviewBtn = $('.btn--review');
var reviewSave = $('.review-save');
var closeReview = $('.close');
// Delegation
if (mapBox) {
...
if (reviewSave) {
  reviewSave.addEventListener('click', function (e) {
